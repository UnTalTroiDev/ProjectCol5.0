...
class DatasetURLS:
    ...
    mobility_aforos_vehiculares: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-023-25-000301/"
        "Aforos_Vehiculares.csv"
    )
    mobility_victimas_incidentes_viales: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-023-25-000360/"
        "Mede_Victimas_inci.csv"
    )

    # ── Seguridad ──────────────────────────────────────────────────────────
    safety_homicidios: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-027-23-000008/"
        "homicidio.csv"
    )
    safety_lesiones_comunes: str = field(
        default_factory=lambda: os.getenv(
            "MEDATA_LESIONES_URL",
            "https://medata.gov.co/sites/default/files/distribution/1-027-23-000007/"
    ...
    security_criminalidad_consolidada: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-027-23-000306/"
        "consolidado_cantidad_casos_criminalidad_por_anio_mes.csv"
    )
    social_violencia_intrafamiliar: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-027-23-000028/"
    ...
    health_natalidad: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-026-22-000029/"
        "natalidad.csv"
    )
    health_hospitalizacion: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-026-22-000126/"
        "registro_hospitalizacion_prestacion_servicios_medicos.csv"
    )

    # ── Educación ──────────────────────────────────────────────────────────
    education_establecimientos: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-011-08-000122/"
        "directorio_establecimientos_educativos.csv"
    )
    education_ambiente_escolar: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-011-08-000068/"
        "historico_indicadores_ambiente_escolar.csv"
    )

    # ── Medio Ambiente ─────────────────────────────────────────────────────
    environment_residuos_solidos: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-028-02-000599/"
        "generacion_residuos_solidos_centro_administrativo_distrital.csv"
    )

    # ── Calidad de Vida ────────────────────────────────────────────────────
    quality_imcv: str = (
        "https://medata.gov.co/sites/default/files/distribution/1-002-09-000041/"
